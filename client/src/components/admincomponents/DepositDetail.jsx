...
//               <div className="well col-xs-12 col-sm-12 col-md-12">
...
//                                   <td className="col-md-6">
//                                     <em>{deposit?.status || "N/A"}</em>
//                                   </td>
//                                 </tr>
//                                 <tr>
//                                   <td className="col-md-6">Amount</td>
//                                   <td className="col-md-6">
//                                     <em>AED {deposit?.amount || "N/A"}</em>
//                                   </td>
//                                 </tr>
//                               </tbody>
//                             </table>
...
//                                     className="place-bid"
//                                     onClick={() =>
//                                       handleUpdateClick(deposit.invNumber)
//                                     }
//                                   >
//                                     Update
//                                   </button>
...
//                 )}
//                 <hr />
//                 <h1 className="mt-5" style={{ marginBottom: "-5rem" }}>
//                   Deposit History
//                 </h1>
//                 {deposits.map(
//                   (deposit, index) =>
...
//                     </p> */}
            ...
            <div className="row mt-5">
              {renderDeposits((deposit) => deposit.status !== "approved")}
            </div>
